...
urlpatterns = [
    ...
    path('list-pdfs/<str:robo_id>/', list_robot_pdfs, name='list_robot_pdfs'),
    ...
    path('add-ip/<str:robo_id>/', add_ip_address, name='add-ip'),
    path('get-last-ip/<str:robo_id>/', get_last_ip, name='get-last-ip'),


    path('robot-stop/<str:robo_id>/', stop_robot, name='robot-stop-create'),
    path('robot-start/<str:robo_id>/', start_robot, name='robot-start'),
    path('api/robot/status/<str:robo_id>/', get_current_robot_status, name='robot-current-status'),
