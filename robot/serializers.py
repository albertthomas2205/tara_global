...
class RobotSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'robo_name', 'robo_id', 'active_status', 
                  ...
                  'created_at', 'subscription', 'language', 'image','voltage','current','voltage','power','energy','quality','map','emergency_stop','motor_brake_released','ready_to_navigate','volume','charging','is_purchased','dockingStatus']
        extra_kwargs = {
...
class IPAddressSerializer(serializers.ModelSerializer):
    class Meta:
        model = IPAddress
        fields = ['robot', 'ip_address', 'created_at']


class RobotStopSerializer(serializers.ModelSerializer):
    class Meta: 
        model=RobotStop
        fields=['robot','status']
...
class RobotStatusSerializer(serializers.ModelSerializer):
    class Meta:
        model = RobotStatus
        fields = ['id', 'robot', 'status', 'offline']
        read_only_fields = ['offline']
