...
class RobotSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'robo_name', 'robo_id', 'active_status', 
                  ...
                  'created_at', 'subscription', 'language', 'image','voltage','current','voltage','power','energy','quality','map','emergency_stop','motor_brake_released','ready_to_navigate','volume','charging','dockingStatus']
        extra_kwargs = {
