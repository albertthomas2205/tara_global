...
SECRET_KEY = 'django-insecure-jfbr7%m1$c%ucsh6mdy0rg!y4al4*qg^!1%0819n97mbx7&3%_'
...
SUPERUSER_CREATE_KEY = config("SUPERUSER_CREATE_KEY")
...
EMAIL_HOST_USER ='taraihubrobotics@gmail.com'
EMAIL_HOST_PASSWORD ='lmtpfrtjnceyrkls'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
...
BUNNY_API_KEY = config("BUNNY_CDN_API_KEY")
BUNNY_CDN_STORAGE_ZONE = config("BUNNY_CDN_STORAGE_ZONE")
